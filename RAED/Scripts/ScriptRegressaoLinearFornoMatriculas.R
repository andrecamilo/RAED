...
`matrculas` <- read.csv(file = "C:/Users/andrecamilo/AppData/Local/Temp/matrculas.csv.utf8", header = TRUE, row.names = NULL, encoding = "UTF-8", sep = ";", dec = ".", quote = "\"", comment.char = "")

View(matrculas)

dep <- matrculas$Localidade
