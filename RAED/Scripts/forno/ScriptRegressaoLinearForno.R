forno <- read.csv(file = "C:/Users/andrecamilo/Documents/Visual Studio 2017/Projects/R/RAED/RAED/Datasets/forno.csv", header = TRUE, row.names = NULL, encoding = "UTF-8", sep = ",", dec = ".", quote = "/", comment.char = "")
View(forno)
forno
